...
import arcade.chess.pieces.Pawn;
import arcade.chess.pieces.Piece;
...
public class Square extends StackPane {
        ...
        if (this.getPiece().getType() == 'K') {
            if (target.coordinate - this.coordinate == 20 || target.coordinate - this.coordinate == -20) {
                if (target.coordinate == 67) {
                    getBoard().getSquareArr()[5][7].setPiece(getBoard().getSquareArr()[7][7].getPiece());
                    getBoard().getSquareArr()[5][7].getPiece().setFirstMove(false);
                    getBoard().getSquareArr()[5][7].getPiece().setCoordinate(57);
                    getBoard().getSquareArr()[5][7].getPiece().setSquare(getBoard().getSquareArr()[5][7]);
                    getBoard().getSquareArr()[7][7].setPiece(new Empty(7, 7));
                } else if (target.coordinate == 27) {
                    getBoard().getSquareArr()[3][7].setPiece(getBoard().getSquareArr()[0][7].getPiece());
                    getBoard().getSquareArr()[3][7].getPiece().setFirstMove(false);
                    getBoard().getSquareArr()[3][7].getPiece().setCoordinate(37);
                    getBoard().getSquareArr()[3][7].getPiece().setSquare(getBoard().getSquareArr()[3][7]);
                    getBoard().getSquareArr()[0][7].setPiece(new Empty(0, 7));
                } else if (target.coordinate == 20) {
                    getBoard().getSquareArr()[3][0].setPiece(getBoard().getSquareArr()[0][0].getPiece());
                    getBoard().getSquareArr()[3][0].getPiece().setFirstMove(false);
                    getBoard().getSquareArr()[3][0].getPiece().setCoordinate(30);
                    getBoard().getSquareArr()[3][0].getPiece().setSquare(getBoard().getSquareArr()[3][0]);
                    getBoard().getSquareArr()[0][0].setPiece(new Empty(0, 0));
                } else if (target.coordinate == 60) {
                    getBoard().getSquareArr()[5][0].setPiece(getBoard().getSquareArr()[7][0].getPiece());
                    getBoard().getSquareArr()[5][0].getPiece().setFirstMove(false);
                    getBoard().getSquareArr()[5][0].getPiece().setCoordinate(50);
                    getBoard().getSquareArr()[5][0].getPiece().setSquare(getBoard().getSquareArr()[5][0]);
                    getBoard().getSquareArr()[7][0].setPiece(new Empty(7, 0));
                }
            }
        }
    }
    ...
    public boolean ifCheckMate(Square target) {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                Piece piece = getBoard().getSquareArr()[i][j].getPiece();
    ...
    public Square checkPawn(Square target) {
        if (piece.getType() == 'P') {
            if (target.y == 0 || target.y == 7) { //promotion
                board.getApp().createPromotion(new Promotion(piece.getColor() == -1, target.coordinate, board.getApp()));
            } else {
                ...
                if (x == target.x && y + (2 * piece.getColor()) == target.y) { //double move
                    ...
                    if (pawn.getEnPassant() == target.coordinate) { //en passant
                        pawn.setEnPassant(-1);
                        return board.getSquareArr()[target.x][target.y - piece.getColor()];
                    }
                }
            }
        }
    ...
    public void checkTaken(Square taken) {
        if (taken.getPiece().getColor() == -1) {
            board.getApp().getBlack().getTaken().add(taken.getPiece());
            board.getApp().getBlack().getTaken().updateDifference(board.getApp().getWhite().getTaken());
            taken.setPiece(new Empty(taken.x, taken.y)); //remove en passant piece
        } else if (taken.getPiece().getColor() == 1) {
            board.getApp().getWhite().getTaken().add(taken.getPiece());
            board.getApp().getWhite().getTaken().updateDifference(board.getApp().getBlack().getTaken());
