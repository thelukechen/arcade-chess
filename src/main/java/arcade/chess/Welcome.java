...
public class Welcome extends VBox {
    ...
    public Welcome() {
        ...
        arcade = new ImageView(new Image("/arcade.png", 200, 200, true, true));
        game = new Label("You have chosen chess.");
        game.setFont(Font.font("Verdana", FontWeight.SEMI_BOLD, 14));
        game.setTextFill(Color.WHITE);
        chess = new ImageView(new Image("/chess.png", 150, 150, false, false));
        ImageView enterIv = new ImageView(new Image("/enter.png", 50, 50, true, true));
        button = new HBox();
